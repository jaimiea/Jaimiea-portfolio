...
| Question 2 | Yes, it is very clear and informational in terms of structure, taking you through all of the questions one would have 
about the topic.| Yes. The general information in the beginning allows us to understand the problem. Then, we look into more specifics about what is lacking. The end has some mentions about what are some of the first topics to tackle first. | Yes. This follows a very clear story: here is the problem, what caused the problem, and here’s how we can fix it. |
