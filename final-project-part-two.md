...
| Combine OECD graphs| My group also mentioned it might be interesting to combine the OECD data on expenditure in a combined line graph with the OECD maternal mortality rates. They advised this could potentially show an interesting relationship between the metrics.|
